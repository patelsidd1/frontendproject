        ...
        <Grid item xs={12} sm={3}>
          <Card className={classes.card}>
            <CardHeader
              ...
              title={
                <div>
                  <i className={`fa fa-chalkboard-teacher ${classes.cardIcon}`} />
                </div>
              }
              subheader={
                <div>
              ...
              subheader={
                <div className="text-center mt-5">
                  <Typography variant="body1">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, animi quasi suscipit magnam
                    alias, similique optio molestias repellat quia ullam voluptatibus ipsum. Debitis esse tempore
                    asperiores in saepe quidem architecto?
                  </Typography>
                  <a href="#">Show more</a>
                </div>
              }
